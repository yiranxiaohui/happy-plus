...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Happy Plus Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor Happy Plus válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão Happy Plus copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Happy Plus',
        happySessionId: 'ID da sessão Happy Plus',
        ...
        happyHome: 'Diretório Happy Plus',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Happy Plus CLI',
            runIt: 'Execute',
    ...
    files: {
        ...
        filesTruncated: ({ count }: { count: number }) => `Mostrando os primeiros ${count} arquivos`,
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Happy Plus Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
