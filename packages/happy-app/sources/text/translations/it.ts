...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Happy Plus Coder è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Happy Plus Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione Happy Plus copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Happy Plus',
        happySessionId: 'ID sessione Happy Plus',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Happy Plus',
            runIt: 'Avviala',
    ...
    files: {
        ...
        filesTruncated: ({ count }: { count: number }) => `Mostrando i primi ${count} file`,
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Happy Plus Coder. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
