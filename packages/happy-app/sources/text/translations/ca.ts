...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Happy Plus Coder és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Happy Plus vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Happy Plus copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Happy Plus',
        happySessionId: 'ID de la sessió de Happy Plus',
        ...
        happyHome: 'Directori de Happy Plus',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Happy Plus CLI',
            runIt: 'Executa\'l',
    ...
    files: {
        ...
        filesTruncated: ({ count }: { count: number }) => `Mostrant els primers ${count} fitxers`,
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Happy Plus Coder. Això permetrà al terminal enviar i rebre missatges de forma segura.',
