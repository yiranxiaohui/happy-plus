...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Happy Plus Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Happy Plus válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Happy Plus copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Happy Plus',
        happySessionId: 'ID de sesión de Happy Plus',
        ...
        happyHome: 'Directorio de Happy Plus',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Happy Plus CLI',
            runIt: 'Ejecútelo',
    ...
    terminal: {
        ...
        title: 'Terminal',
        open: 'Abrir terminal',
        ended: 'Terminal finalizado',
        reconnected: 'Reconectado',
        disabled: 'La terminal está deshabilitada en esta máquina',
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Happy Plus Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
